...
3. **Kaynak ve hedef**:
    ...
    ![Hyper-V/VMM çoğaltma Azure için](./media/site-recovery-components/arch-onprem-onprem-azure-vmm.png) ![Hyper-V sitesi çoğaltma Azure için](./media/site-recovery-components/arch-onprem-azure-hypervsite.png)
...
4. **İşler** sekmesinde işi izleyebilirsiniz.
        ![İşler listesi](media/site-recovery-hyper-v-azure-architecture/image1.png) ![Korumayı etkinleştir ayrıntıları](media/site-recovery-hyper-v-azure-architecture/image2.png)
