...
Kullanım [az acr oturum açma](https://docs.microsoft.com/cli/azure/acr#az_acr_login) doğrulamak ve kayıt için kimlik bilgilerini önbelleğe komutu. Değiştir `<acrName>` önceki adımlarda oluşturduğunuz kayıt defteri adı.
