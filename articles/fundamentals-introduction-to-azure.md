...
Sayfa [Azure Web uygulamaları, bulut Hizmetleri ve sanal makineler karşılaştırması](app-service-web/choose-web-site-cloud-service-vm.md) daha ayrıntılı bir işlem modeli seçin hakkında bilgi sağlar.
