...
Bir Azure Batch hesabı kullanarak oluşturduğunuz [Azure portal](http://manage.windowsazure.com/). Bkz: [oluşturma ve bir Azure Batch hesabını yönetmek](../batch/batch-account-create-portal.md). Azure Batch hesabı adını ve hesap anahtarını unutmayın. Aynı zamanda [New-AzureRmBatchAccount](https://msdn.microsoft.com/library/mt603749.aspx) bir Azure Batch hesabı oluşturmak için cmdlet'i. Bkz: [Azure Batch PowerShell cmdlet'leri kullanmaya başlama](../batch/batch-powershell-cmdlets-get-started.md) bu cmdlet'in kullanımı hakkında ayrıntılı yönergeler için.
