...
Bir Data Factory çözümünde bir veya daha fazla [işlem hattı](data-factory-create-pipelines.md) oluşturursunuz. Bir işlem hattı görevi birlikte gerçekleştiren etkinlikler mantıksal bir gruplandırmasıdır. Bu ardışık düzen veri fabrikası oluşturulduğu bölgede yer alır. 
