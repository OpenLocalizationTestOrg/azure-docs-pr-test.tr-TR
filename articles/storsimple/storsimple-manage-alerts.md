...
---
# <a name="use-hello-storsimple-manager-service-tooview-and-manage-storsimple-alerts"></a>Merhaba StorSimple Yöneticisi hizmet tooview kullanın ve StorSimple Uyarıları yönetme
## <a name="overview"></a>Genel Bakış
Merhaba **uyarıları** hello StorSimple Yöneticisi hizmeti sekmesinde bir yöntem sunar, tooreview ve Temizle StorSimple cihaz – ilgili uyarıları bir gerçek zamanlı olarak. Bu sekmeden, merkezi olarak StorSimple aygıtlarınızın hello sistem durumu sorunları izleyebilir ve genel Microsoft Azure StorSimple çözümünüzle hello.
...
1. Çok Git**aygıtları** > **yapılandırma** hello cihaz için.
2. Altında **uyarı ayarlarını**, hello aşağıdakileri ayarlayın:
...
3. toosend bir test e-posta bildirimi hello ok simgesini tıklatın ardından çok**test e-postası gönderme**. Merhaba test bildirimi iletir gibi hello StorSimple Yöneticisi hizmeti durum iletilerini görüntüler. 
4. Merhaba aşağıdaki ileti görüntülendiğinde **Tamam**. 
   
    ![Gönderilen bildirim e-posta uyarıları test](./media/storsimple-manage-alerts/HCS_AlertNotificationConfig3.png)
   
   > [!NOTE]
   > Merhaba sınama bildirim iletisi gönderilemiyor, hello StorSimple Yöneticisi hizmeti uygun bir mesaj görüntüler. Tıklatın **Tamam**, birkaç dakika bekleyin ve sonra toosend sınama bildirim iletisini yeniden deneyin. 
   > 
   > 

## <a name="view-and-track-alerts"></a>Görünüm ve izleme uyarıları
Merhaba StorSimple Yöneticisi hizmet panosunu hello sayıda uyarı önem düzeyine göre düzenlenmiş cihazlarınızda hızlı bir bakışta sağlar.

![Uyarılar Panosu](./media/storsimple-manage-alerts/admin_alerts_dashboard.png)

Merhaba önem düzeyi tıklatıldığında açılır hello **uyarıları** sekmesini hello sonuçlarında yalnızca bu önem düzeyi eşleşen hello uyarılar.
...
Böylece gözden geçirin ve bunları gruplara temizleyin, uyarıları daha verimli toorun raporlarda bulabilirsiniz. Ayrıca, hello **uyarıları** sekmesini too250 uyarılarını görüntüleyebilir. Bu uyarı sayısı aşılırsa, tüm uyarıları hello varsayılan görünümünde görüntülenir. Hangi uyarılar görüntülenir alanları toocustomize aşağıdaki hello birleştirebilirsiniz:
...
| Yaklaşan sürücü hatası algılandı. | Yaklaşan sürücü hatası algılandı. |Merhaba donanım bileşeni için yaklaşan bir sürücü hatası tespit ettik ' yuvasına sürücü <*kimliği yuva*>, muhafaza <*muhafaza kimliği*>'. Sürücünüzün değiştirmeyi düşünün. <br> Merhaba disk değiştirme başlamadan önce aşağıdaki bilgilerle hello gözden geçirin.<br><br>Cihazınızı birden fazla başarısız disk varsa, birden fazla SSD veya HDD herhangi bir zamanda kaldırmayın. Bunun yapılması, veri kaybına neden olabilir.<br><br>Daha önce bir SSD bulunan bir yuvada SSD yerine koyun emin olun. Merhaba aynı bir HDD için geçerlidir.<br><br>Yuva 0 too11 numaralandırılır. Başarısız disk 2 yuvasındaki tooa başarısız disk yuvasında 3 hello aygıtının (üstten sol hello) eşler.<br><br>Disk değiştirme hakkında daha fazla bilgi için toohttps://go.microsoft.com/fwlink/?linkid=838653 gidin. Sorun devam ederse, https://go.microsoft.com/fwlink/?linkid=838654 aracılığıyla Microsoft Destek'e başvurun. |
...
| Uyarı metni | Olay | Daha fazla bilgi / önerilen eylemleri |
|:--- |:--- |:--- |
| Merhaba aygıt yük aştı <*eşik*>. |Beklenen yanıt süreleri daha yavaş çalışır. |Cihazınızı kullanımı ağır bir giriş/çıkış yük altında bildirir. Bu cihaz toonot çalışmanızı yanı sıra gerektiği neden olabilir. Toohello aygıt eklenmiş ve olup olmadığını tooanother aygıt ya da, artık gerekli olmayan taşınamıyor herhangi belirlemek hello iş yükleri gözden geçirin.<br>toounderstand Merhaba geçerli durumu, çok Git[kullanım Cihazınızı StorSimple Yöneticisi hizmet toomonitor hello](storsimple-monitor-device.md) |
