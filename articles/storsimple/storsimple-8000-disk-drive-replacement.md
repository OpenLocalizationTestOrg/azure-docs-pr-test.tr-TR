...
5. Değiştirme başarılı olduğunu ve sürücünün çalışır durumda olduğunu doğrulayın. Azure portalına erişmek ve gidin **ayarları** > **donanım durumu**. Altında **paylaşılan bileşenleri** veya **EBOD paylaşılan bileşenleri**, sürücü durumu sağlıklı olduğunu gösteren yeşil olması gerekir.
