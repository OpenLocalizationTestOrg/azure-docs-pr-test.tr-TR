...
StorSimple cihaz Yöneticisi hizmeti, StorSimple çözümünüzün içinde belirli aygıtları izlemek için kullanabilirsiniz. G/ç performansı, kapasite kullanımı, ağ verimliliğini ve cihaz performans ölçümleri göre özel grafikler oluşturma ve bu panoya Sabitle. Daha fazla bilgi için Git [portal panonuzu özelleştirebilir](/articles/azure-portal/azure-portal-dashboards.md).
