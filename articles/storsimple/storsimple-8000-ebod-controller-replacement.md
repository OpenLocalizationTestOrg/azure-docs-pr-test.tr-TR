...
2. Tooyour aygıt gidin ve çok gidin**ayarları** > **donanım durumu**ve hello etkin EBOD Denetleyici Modülü yeşil ve Merhaba LED başarısız hello için o hello LED hello durumunu doğrulayın EBOD Denetleyici Modülü kırmızı olur.
