...
İşlerini çalıştırdığınızda, genellikle bir şekilde tootrack ilerleyişini gerektirir. Merhaba işin durumu özelliğini kullanarak hello iş durumu bulabilirsiniz. Merhaba State özelliği hakkında daha fazla bilgi için bkz: [işi varlık özellikleri](https://docs.microsoft.com/rest/api/media/operations/job#job_entity_properties).
