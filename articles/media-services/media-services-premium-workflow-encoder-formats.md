...
Bu belge giriş ve çıkış dosya biçimlerini ve hello genel Önizleme sürümü hello tarafından desteklenen codec bileşenleri listesini içeren **Medya Kodlayıcısı Premium iş akışı** Kodlayıcı.
...
bölümden hello girdi olarak bu medya işlemcisi destekleyen hello codec bileşenleri ve dosya biçimlerini listeler.
...
* AVC 8 bit/10-bit too4:2:2 AVCIntra dahil olmak üzere, ayarlama
* Hırslı DNxHD (içinde MXF)
* DVCPro/DVCProHD (içinde MXF)
* JPEG2000
* MPEG-2 (too422 profili ve yüksek düzey; XDCAM, XDCAM HD, XDCAM IMX, CableLabs® ve D10 gibi çeşitleri dahil)
* MPEG-1
...
* Dolby® E
* Dolby® dijital (AC3)
* AAC (AAC-LC, HE AAC ve AAC-HEv2; too5.1 yukarı)
* MPEG Katman 2
...
Merhaba aşağıdaki bölümde bu medya işlemcisi çıktısı olarak desteklenen hello codec bileşenleri ve dosya biçimlerini listelenmektedir.
...
* AVC (H.264; 8 bit; yukarı tooHigh profili düzeyi 5.2; 4K Ultra HD; AVC içi)
* Hırslı DNxHD (içinde MXF)
* DVCPro/DVCProHD (içinde MXF)
* MPEG-2 (too422 profili ve yüksek düzey; XDCAM, XDCAM HD, XDCAM IMX, CableLabs® ve D10 gibi çeşitleri dahil)
* MPEG-1
...
* AES (SMPTE 331 M ve 302 M, AES3 2003)
* Dolby® dijital (AC3)
* Dolby® dijital Plus (E-AC3) too7.1 ayarlama
* AAC (AAC-LC, HE AAC ve AAC-HEv2; too5.1 yukarı)
* MPEG Katman 2
* MP3 (MPEG-1 ses Katman 3)
* Windows Media Ses
...
Çıktı, aşağıdaki seçenekleri şu hello kullanılabilir:

1. CEA 608 tooCEA 708 çevirisi
...
Not: tüm çıkış biçimleri yukarıda hello Azure Media Services akış aracılığıyla teslim için desteklenir.
