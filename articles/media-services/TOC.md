...
## [AAD auth tooaccess API kullanın](media-services-use-aad-auth-to-access-ams-api.md)
### [Portal toomanage AAD auth kullanın](media-services-portal-get-started-with-aad.md)
...
### [CLI toocreate kullanın ve AAD uygulamayı yapılandırma](media-services-cli-create-and-configure-aad-app.md)
### [PowerShell toocreate kullanın ve AAD uygulamayı yapılandırma](media-services-powershell-create-and-configure-aad-app.md)
...
#### [MES tooauto kullanın-bit hızı Merdiveni oluştur](media-services-autogen-bitrate-ladder-with-mes.md)
...
##### [Nasıl toogenerate küçük resimleri Medya Kodlayıcısı standart .NET ile kullanma](media-services-dotnet-generate-thumbnail-with-mes.md)
...
### [İçerik koruma hello portalında yapılandırın](media-services-portal-protect-content.md)
### [Akışınız için AES-128 şifresiz anahtarını yapılandırma](media-services-protect-with-aes128.md)
### [REST tooencrypt içeriğinizi depolama şifrelemesi ile kullanma](media-services-rest-storage-encryption.md)
...
### [İş ortakları toodeliver Widevine kullanarak tooMedia Hizmetleri lisansları](media-services-licenses-partner-integration.md)
#### [Toodeliver Widevine lisansları tooMedia Axinom kullanan hizmetler](media-services-axinom-integration.md)
#### [Toodeliver Widevine lisansları tooMedia castLabs kullanan hizmetler](media-services-castlabs-integration.md)
...
### [Merhaba portal kullanarak medya Çözümle](media-services-portal-analyze.md)
...
### [Merhaba istemci tarafında ADs Ekle](media-services-inserting-ads-on-client-side.md)
