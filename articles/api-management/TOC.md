...
## [Önbelleğe alma tooimprove performans ekleme](api-management-howto-cache.md)
...
### [Tooa sanal ağa bağlan](api-management-using-with-vnet.md)
### [Tooan iç sanal ağa bağlan](api-management-using-with-internal-vnet.md)
...
## Merhaba Geliştirici deneyimini özelleştirme
...
### [Toomultiple Azure dağıtmak bölgeleri](api-management-howto-deploy-multi-region.md)
### [Olayları tooAzure olay hub'ları oturum](api-management-howto-log-event-hubs.md)
### [Yedekleme/geri yükleme kullanarak DR'yi ayarlama](api-management-howto-disaster-recovery-backup-restore.md)
### [Merhaba API Inspector ile izleme çağrıları](api-management-howto-api-inspector.md)
...
## [Olay hub'ları tooAPI yönetim bağlanma](http://weblogs.asp.net/cschittko/connecting-eventhubs-to-api-management)
...
## [Merhaba REST API kullanarak RBAC benzeri erişim sağlar](http://blogs.msdn.com/b/katriend/archive/2015/12/21/using-the-azure-api-management-rest-api-as-workaround-to-rbac-functionality.aspx)
## [Hizmet güncelleştirmeleri](https://azure.microsoft.com/updates/?product=api-management)
## [PostMan toocall API Management API'leri ayarlayın](http://www.bizbert.com/bizbert/2015/07/08/Setting+Up+PostMan+To+Call+The+Azure+Management+APIs.aspx)
