...
## [Nasıl tooget Azure MFA](multi-factor-authentication-versions-plans.md)

# başlarken
## [Konumu seçin toodeploy](multi-factor-authentication-get-started.md)
## [Merhaba bulutta MFA](multi-factor-authentication-get-started-cloud.md)
...
#### [Merhaba kullanıcı portalını yükle](multi-factor-authentication-get-started-portal.md)
