...
BT departmanınız, iki aşamalı doğrulama kullanarak toostart gerektirdiğinde ekran bildiren **yöneticiniz bu hesabı ek güvenlik doğrulaması için ayarlamanızı zorunlu kıldı** görünür:
...
10. Bu noktada, tarayıcı olmayan uygulamaları Outlook 2010 gibi veya daha eski veya Apple cihazlarda hello yerel e-posta uygulaması için uygulama parolaları yukarı istendiğinde tooset var. Bu eylem, bazı uygulamalar iki aşamalı doğrulamayı desteklemeyen nedeni. Bu uygulamaları kullanmıyorsanız tıklatın **Bitti** ve hello kalan adımları atlayın.
...
5. Bu noktada, tarayıcı olmayan uygulamaları Outlook 2010 gibi veya daha eski veya Apple cihazlarda hello yerel e-posta uygulaması için uygulama parolaları yukarı istendiğinde tooset var. Bu eylem, bazı uygulamalar iki aşamalı doğrulamayı desteklemeyen nedeni. Bu uygulamaları kullanmıyorsanız tıklatın **Bitti** ve hello adımları hello kalanını atlayın.
