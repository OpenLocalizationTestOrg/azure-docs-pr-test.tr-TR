...
4. Arama kutusuna **kutusunu**.

    ![Bir Azure AD test kullanıcısı oluşturma](./media/active-directory-saas-box-tutorial/tutorial_box_search.png)

5. Sonuçlar panelinde seçin **kutusunu**ve ardından **Ekle** uygulama eklemek için düğmesi.
...
Bu bağlantı değeri atayarak ilişkisi **kullanıcı adı** değeri olarak Azure AD'de **kullanıcıadı** kutusunda.
...
3. **[Kutusunu test kullanıcısı oluşturma](#creating-a-box-test-user)**  - Britta Simon, karşılık gelen kullanıcı Azure AD gösterimini bağlı kutusunu sağlamak için.
...
3. Üzerinde **kutusunu etki alanı ve URL'leri** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    İçinde **oturum açma URL'si** metin kutusuna, URL şu biçimi kullanarak bir yazın:`https://<subdomain>.box.com`
