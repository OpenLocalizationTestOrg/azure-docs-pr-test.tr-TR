...
Bu öğreticide, bilgi nasıl toointegrate ClickTime Azure Active Directory'ye (Azure AD).

ClickTime Azure AD ile tümleştirme ile Merhaba aşağıdaki avantajları sağlar:

- Erişim tooClickTime sahip Azure AD'de kontrol edebilirsiniz
- Kullanıcıların tooautomatically get açan tooClickTime (çoklu oturum açma) Azure AD hesaplarına sahip etkinleştirebilirsiniz
...
tooconfigure ClickTime ile Azure AD tümleştirme, aşağıdaki öğelerindeki hello gerekir:
...
1. Merhaba Galerisi'nden ClickTime ekleme
2. Çoklu oturum açmayı yapılandırma ve Azure AD sınama

## <a name="adding-clicktime-from-hello-gallery"></a>Merhaba Galerisi'nden ClickTime ekleme
Azure AD'ye tooconfigure hello tümleştirme ClickTime, tooadd ClickTime hello galeri tooyour listesinden yönetilen SaaS uygulamaları gerekir.

**tooadd ClickTime hello galerisinden hello aşağıdaki adımları gerçekleştirin:**
...
4. Merhaba arama kutusuna yazın **ClickTime**seçin **ClickTime** sonuç panelinden ardından **Ekle** düğmesini tooadd Merhaba uygulaması.
...
Tek toowork'ın oturum açma hangi hello karşılık gelen ClickTime içinde tooa kullanıcı Azure AD içinde olduğu Azure AD tooknow gerekir. Diğer bir deyişle, bir Azure AD kullanıcı ve ilgili kullanıcı ClickTime hello arasında bir bağlantı ilişkisi kurulan toobe gerekir.

Merhaba hello değeri ClickTime içinde atayın **kullanıcı adı** hello hello değeri olarak Azure AD'de **kullanıcıadı** tooestablish hello bağlantı ilişkisi.

tooconfigure ve ClickTime ile Azure AD çoklu oturum açmayı test, yapı taşları aşağıdaki toocomplete hello gerekir:
...
3. **[ClickTime test kullanıcısı oluşturma](#create-a-clicktime-test-user)**  -toohave Britta Simon kullanıcı bağlantılı toohello Azure AD gösterimidir ClickTime içinde karşılık gelen.
...
Bu bölümde, Azure AD çoklu oturum açma hello Azure portal'ın etkinleştirin ve çoklu oturum açma ClickTime uygulamanızda yapılandırın.

**tooconfigure Azure AD çoklu oturum açma ile ClickTime, hello aşağıdaki adımları gerçekleştirin:**

1. Hello hello üzerinde Azure portal'ın **ClickTime** uygulama tümleştirme sayfasını tıklatın **çoklu oturum açma**.
...
3. Merhaba üzerinde **ClickTime etki alanı ve URL'leri** bölümünde, hello aşağıdaki adımları gerçekleştirin:
    ...
    a. Merhaba, **tanımlayıcısı** metin kutusuna, URL'yi yazın:`https://app.clicktime.com/sp/`
...
6. Merhaba üzerinde **ClickTime yapılandırma** 'yi tıklatın **yapılandırma ClickTime** tooopen **yapılandırma oturum açma** penceresi. Kopya hello **SAML çoklu oturum açma hizmet URL'si** hello gelen **hızlı başvuru bölümü.**
...
8. Merhaba üstte Hello araç çubuğunda **Tercihler**ve ardından **güvenlik ayarlarını**.

9. Merhaba, **tek oturum açma tercihleri** yapılandırma bölümünde, hello aşağıdaki adımları gerçekleştirin:
    ...
    b. Merhaba, **kimlik sağlayıcısı Endpoint** metin kutusuna, Yapıştır **SAML çoklu oturum açma hizmet URL'si** Azure portalından kopyalanan.
   
    c.  Açık hello **base-64 kodlamalı sertifika** Azure portalında indirilen **not defteri**hello içeriği Kopyala ve hello yapıştırma **X.509 sertifikası** metin kutusu.
...
ClickTime içine sipariş tooenable Azure AD kullanıcıların toolog bunların ClickTime sağlanmalıdır.  
ClickTime Hello durumda sağlama bir el ile bir görevdir.

> [!NOTE]
> API'leri, Azure AD kullanıcı hesapları ClickTime tooprovision tarafından sağlanan veya herhangi diğer ClickTime kullanıcı hesabı oluşturma araçlarını kullanabilirsiniz.

**bir kullanıcı hesabı tooprovision hello aşağıdaki adımları gerçekleştirin:**
1. İçinde tooyour oturum **ClickTime** Kiracı.
2. Merhaba üstte Hello araç çubuğunda **şirket**ve ardından **kişiler**.
...
4. Hello yeni bir kişiye bölümü, hello aşağıdaki adımları gerçekleştirin:
   
    ![Kişiler](./media/active-directory-saas-clicktime-tutorial/tic777284.png "kişiler")
   
    a.  Merhaba, **tam adı** metin kutusuna, tam ad kullanıcı türünü gibi **Britta Simon**. 
  
    b.  Merhaba, **e-posta adresi** metin kutusuna, kullanıcının türü hello e-posta ister  **brittasimon@contoso.com** .
       
    > [!NOTE]
    > İsterseniz, hello yeni kişi nesnesi ek özellikleri ayarlayabilirsiniz.
   
    c.  **Kaydet** düğmesine tıklayın.

### <a name="assign-hello-azure-ad-test-user"></a>Hello Azure AD test kullanıcısı atayın

Bu bölümde, erişim tooClickTime vererek Britta Simon toouse Azure çoklu oturum açmayı etkinleştirin.

![Merhaba kullanıcı rolü atayın][200] 

**tooassign Britta Simon tooClickTime hello aşağıdaki adımları gerçekleştirin:**

1. Hello Azure portal, hello uygulamaları görünümü Aç ve ardından toohello dizin görünümüne gidin ve çok Git**kurumsal uygulamalar** ardından **tüm uygulamaları**.

    ![Kullanıcı atama][201] 

2. Merhaba uygulamalar listesinde **ClickTime**.
...
Merhaba ClickTime hello erişim paneli parçasında tıkladığınızda, otomatik olarak oturum açma tooyour ClickTime uygulama almanız gerekir.
