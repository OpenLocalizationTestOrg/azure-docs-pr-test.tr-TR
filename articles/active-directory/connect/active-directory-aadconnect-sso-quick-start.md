...
>[!IMPORTANT]
>Sorunsuz SSO özelliği şu anda önizlemede değil.
...
- Azure AD Connect ile iletişim kurabilir `*.msappproxy.net` URL'leri ve üstünde bağlantı noktası 443'tür. Yalnızca asıl kullanıcı oturum açma işlemleri için özelliğini etkinleştirdiğinizde bu geçerli bir önkoşuldur.
- Azure AD Connect, doğrudan IP bağlantılar yapabilir [Azure veri merkezi IP aralıkları](https://www.microsoft.com/download/details.aspx?id=41653). Yeniden yalnızca özelliğini etkinleştirdiğinizde bu önkoşulu geçerlidir.
...
Kullanıcılarınız için özelliği geri dönmek için iki Azure AD URL'leri (https://autologon.microsoftazuread-sso.com ve https://aadg.windows.net.nsatc.net) eklemek için kullanıcıların Intranet bölgesi ayarlarını Active Directory'de Grup İlkesi aracılığıyla gerekir.
