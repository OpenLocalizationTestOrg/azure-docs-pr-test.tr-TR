...
4. Arama kutusuna **KnowBe4 güvenlik tanıma eğitim**.

    ![Bir Azure AD test kullanıcısı oluşturma](./media/active-directory-saas-KnowBe4-tutorial/tutorial_knowbe4sat_search.png)

5. Sonuçlar panelinde seçin **KnowBe4 güvenlik tanıma eğitim**ve ardından **Ekle** uygulama eklemek için düğmesi.
...
3. **[KnowBe4 güvenlik tanıma eğitim test kullanıcısı oluşturma](#creating-a-knowbe4-security-awareness-training-test-user)**  - Britta Simon, karşılık gelen kullanıcı Azure AD gösterimini bağlı KnowBe4 güvenlik tanıma eğitim sağlamak için.
...
3. Üzerinde **KnowBe4 güvenlik tanıma eğitim etki alanı ve URL'leri** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    İçinde **oturum açma URL'si** metin kutusuna, URL şu biçimi kullanarak bir yazın:`https://<companyname>.KnowBe4.com/auth/saml/<instancename>`

    > [!NOTE] 
    > Değer gerçek değil. Değerin gerçek oturum açma URL'si ile güncelleştirin. Kişi [KnowBe4 güvenlik tanıma eğitim istemci destek ekibi](mailto:support@KnowBe4.com) değeri alınamıyor. 
