...
Bu öğreticide, bilgi nasıl toointegrate Bime Azure Active Directory'ye (Azure AD).

Bime Azure AD ile tümleştirme ile Merhaba aşağıdaki avantajları sağlar:

- Erişim tooBime sahip Azure AD'de kontrol edebilirsiniz
- Kullanıcıların tooautomatically get açan tooBime (çoklu oturum açma) Azure AD hesaplarına sahip etkinleştirebilirsiniz
...
tooconfigure Bime ile Azure AD tümleştirme, aşağıdaki öğelerindeki hello gerekir:
...
1. Merhaba Galerisi'nden Bime ekleme
2. Çoklu oturum açmayı yapılandırma ve Azure AD sınama

## <a name="adding-bime-from-hello-gallery"></a>Merhaba Galerisi'nden Bime ekleme
Azure AD'ye tooconfigure hello tümleştirme Bime, tooadd Bime hello galeri tooyour listesinden yönetilen SaaS uygulamaları gerekir.

**tooadd Bime hello galerisinden hello aşağıdaki adımları gerçekleştirin:**
...
4. Merhaba arama kutusuna yazın **Bime**.

    ![Bir Azure AD test kullanıcısı oluşturma](./media/active-directory-saas-bime-tutorial/tutorial_bime_search.png)

5. Merhaba Sonuçlar panelinde seçin **Bime**ve ardından **Ekle** düğmesini tooadd Merhaba uygulaması.
...
Tek toowork'ın oturum açma hangi hello karşılık gelen Bime içinde tooa kullanıcı Azure AD içinde olduğu Azure AD tooknow gerekir. Diğer bir deyişle, bir Azure AD kullanıcı ve ilgili kullanıcı Bime hello arasında bir bağlantı ilişkisi kurulan toobe gerekir.

Merhaba hello değeri Bime içinde atayın **kullanıcı adı** hello hello değeri olarak Azure AD'de **kullanıcıadı** tooestablish hello bağlantı ilişkisi.

tooconfigure ve Bime ile Azure AD çoklu oturum açmayı test, yapı taşları aşağıdaki toocomplete hello gerekir:

1. **[Azure AD çoklu oturum açma yapılandırma](#configuring-azure-ad-single-sign-on)**  -tooenable kullanıcılar toouse bu özellik.
2. **[Bir Azure AD test kullanıcısı oluşturma](#creating-an-azure-ad-test-user)**  -tootest Azure AD çoklu oturum açma Britta Simon ile.
3. **[Bime test kullanıcısı oluşturma](#creating-a-bime-test-user)**  -toohave Britta Simon kullanıcı bağlantılı toohello Azure AD gösterimidir Bime içinde karşılık gelen.
4. **[Atama hello Azure AD test kullanıcısı](#assigning-the-azure-ad-test-user)**  -tooenable Britta Simon toouse Azure AD çoklu oturum açma.
5. **[Çoklu oturum açmayı test](#testing-single-sign-on)**  -tooverify olup hello yapılandırma çalışır.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD çoklu oturum açmayı yapılandırma

Bu bölümde, Azure AD çoklu oturum açma hello Azure portal'ın etkinleştirin ve çoklu oturum açma Bime uygulamanızda yapılandırın.

**tooconfigure Azure AD çoklu oturum açma ile Bime, hello aşağıdaki adımları gerçekleştirin:**

1. Hello hello üzerinde Azure portal'ın **Bime** uygulama tümleştirme sayfasını tıklatın **çoklu oturum açma**.
...
3. Merhaba üzerinde **Bime etki alanı ve URL'leri** bölümünde, hello aşağıdaki adımları gerçekleştirin:

    ![Çoklu oturum açmayı yapılandırın](./media/active-directory-saas-bime-tutorial/tutorial_bime_url.png)

    a. Merhaba, **oturum açma URL'si** metin kutusuna, bir desen aşağıdaki hello kullanarak URL'sini yazın:`https://<tenant-name>.Bimeapp.com`

    b. Merhaba, **tanımlayıcısı** metin kutusuna, bir desen aşağıdaki hello kullanarak URL'sini yazın:`https://<tenant-name>.Bimeapp.com`

    > [!NOTE] 
    > Bu değerler gerçek değildir. Bu güncelleştirme değerler ile Merhaba gerçek oturum açma URL'si ve tanımlayıcısı. Kişi [Bime istemci destek ekibi](https://bime.zendesk.com/hc/categories/202604307-Support-tech-notes-and-tips-) tooget bu değerleri. 
...
6. Merhaba üzerinde **Bime yapılandırma** 'yi tıklatın **yapılandırma Bime** tooopen **yapılandırma oturum açma** penceresi. Kopya hello **SAML çoklu oturum açma hizmet URL'si** hello gelen **hızlı başvuru bölümü.**
...
8. Merhaba araç çubuğunda **yönetici**ve ardından **hesap**.
   
    ![Yönetici](./media/active-directory-saas-bime-tutorial/ic775558.png "yönetici")

9. Merhaba hesap yapılandırma sayfasında hello aşağıdaki adımları gerçekleştirin:
...
TooBime içinde sipariş tooenable Azure AD kullanıcıların toolog bunların Bime sağlanmalıdır. Bime Hello durumda sağlama bir el ile bir görevdir.

**tooconfigure kullanıcı hazırlama, hello aşağıdaki adımları gerçekleştirin:**

1. İçinde tooyour oturum **Bime** Kiracı.

2. Merhaba araç çubuğunda **yönetici**ve ardından **kullanıcılar**.
   
    ![Yönetici](./media/active-directory-saas-bime-tutorial/ic775561.png "yönetici")

3. Merhaba, **kullanıcılar listesi**, tıklatın **yeni kullanıcı Ekle** ("+").
   
    ![Kullanıcıların](./media/active-directory-saas-bime-tutorial/ic775562.png "kullanıcılar")

4. Merhaba üzerinde **kullanıcı ayrıntıları** iletişim sayfasında, hello aşağıdaki adımları gerçekleştirin:
...
>[!NOTE]
>API AAD kullanıcı hesaplarının Bime tooprovision tarafından sağlanan veya herhangi diğer Bime kullanıcı hesabı oluşturma araçlarını kullanabilirsiniz.
>  

### <a name="assigning-hello-azure-ad-test-user"></a>Hello Azure AD test kullanıcısı atama

Bu bölümde, erişim tooBime vererek Britta Simon toouse Azure çoklu oturum açmayı etkinleştirin.

![Kullanıcı atama][200] 

**tooassign Britta Simon tooBime hello aşağıdaki adımları gerçekleştirin:**

1. Hello Azure portal, hello uygulamaları görünümü Aç ve ardından toohello dizin görünümüne gidin ve çok Git**kurumsal uygulamalar** ardından **tüm uygulamaları**.

    ![Kullanıcı atama][201] 

2. Merhaba uygulamalar listesinde **Bime**.
...
Merhaba Bime hello erişim paneli parçasında tıkladığınızda, otomatik olarak oturum açma tooyour Bime uygulama almanız gerekir.
