...
Bu makalede, hello Klasik dağıtım modeli yer almaktadır. Ayrıca [hello Resource Manager dağıtım modelinde statik özel IP adresi yönetmek](virtual-networks-static-private-ip-arm-ps.md).

[!INCLUDE [virtual-networks-static-ip-scenario-include](../../includes/virtual-networks-static-ip-scenario-include.md)]

Merhaba örnek PowerShell komutlarını aşağıdaki önceden oluşturulmuş basit bir ortam bekler. Bu belgede gösterildiği toorun hello komutları istiyorsanız, ilk derleme açıklanan hello test ortamı [VNet oluşturma](virtual-networks-create-vnet-classic-netcfg-ps.md).

## <a name="how-tooverify-if-a-specific-ip-address-is-available"></a>Nasıl belirli bir IP adresi olup olmadığını tooverify
Merhaba, tooverify IP adresi *192.168.1.101* adlı sanal ağ içinde kullanılabilir *TestVNet*hello aşağıdaki PowerShell komutunu çalıştırın ve hello değerini doğrulamak *IsAvailable*:
...
tooview hello statik özel IP adres bilgilerinin hello için VM oluşturulan yukarıdaki hello komut dosyasıyla hello aşağıdaki PowerShell komutunu çalıştırın ve başlangıç değerleri uyun *IPADDRESS*:
...
tooremove hello statik özel IP adresi toohello VM üzerinde aşağıdaki PowerShell komutunu çalıştırma hello hello betikteki eklendi:
