...
Önizleme için kaydetmek üzere eş istediğiniz sanal ağları içeren iki abonelikler için izlediği adımları tamamlayın. Önizleme için kaydetmek için kullanabilirsiniz yalnızca PowerShell aracıdır.
