...
* Çalışma alanı için kullanım verilerini de dahil olmak üzere günlük analizi (OMS) çalışma veri arayın.
* Günlük analizi (OMS) yönetim grupları görüntüleyin.
* Günlük analizi (OMS) arama şemasını alın.
* Günlük analizi (OMS) Intelligence paketlerini listeler.
* Almak ve günlük analizi (OMS) kayıtlı aramalar yürütün.
* Günlük analizi (OMS) depolama yapılandırmasını alır.
...
* Oluşturun ve günlük analizi (OMS) depolama yapılandırması silin.
