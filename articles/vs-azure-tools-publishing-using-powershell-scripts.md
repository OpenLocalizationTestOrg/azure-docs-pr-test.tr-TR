...
Yayımlama betikleri izleyerek yeni bir proje oluşturduğunuzda, Web sitenizi barındıran bir sanal makine için oluşturabileceğiniz [bu yönergeleri](virtual-machines/windows/classic/web-app-visual-studio.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json). Ayrıca [oluşturmak betikler web uygulamaları için Azure App Service'te yayımlama](app-service-web/app-service-web-get-started-dotnet.md).
