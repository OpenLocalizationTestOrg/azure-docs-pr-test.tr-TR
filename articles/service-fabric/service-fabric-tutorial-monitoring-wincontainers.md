...
* Kümenizi yükseltmek için PowerShell'i kullanarak dağıtmak [şablon dağıtma](https://docs.microsoft.com/azure/service-fabric/service-fabric-cluster-creation-via-arm). Azure Resource Manager yükseltme olarak döküm, böylece, mevcut olduğundan gerçekleştirir.
