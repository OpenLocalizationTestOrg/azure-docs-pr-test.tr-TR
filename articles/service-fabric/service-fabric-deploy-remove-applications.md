...
Bir uygulama paketi artık gerekli olmadığında, sistem kaynakları serbest görüntü deposundan silebilirsiniz.
...
Sorun: karşıya yükleme paketi başarıyla tamamlandı ancak [Register-ServiceFabricApplicationType](/powershell/module/servicefabric/register-servicefabricapplicationtype?view=azureservicefabricps) zaman aşımına uğradı.
Deneyin:
