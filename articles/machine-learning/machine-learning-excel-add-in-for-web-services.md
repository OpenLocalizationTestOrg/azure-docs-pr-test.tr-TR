...
Bir web hizmetini dağıtma veya var olan bir Web hizmetini kullanın. Bir web hizmeti dağıtma hakkında daha fazla bilgi için bkz: [gözden geçirme adım 5: Azure Machine Learning Web hizmetini dağıtma](machine-learning-walkthrough-5-publish-web-service.md).
...
1. Bir web hizmetini dağıtma veya var olan bir Web hizmetini kullanın. Bir web hizmeti dağıtma hakkında daha fazla bilgi için bkz: [gözden geçirme adım 5: Azure Machine Learning Web hizmetini dağıtma](machine-learning-walkthrough-5-publish-web-service.md).
2. Tıklatın **tüketen**.
3. Ara **temel tüketim bilgileri** bölümü. Kopyalayıp kaydedin **birincil anahtar** ve **istek-yanıt** URL.
