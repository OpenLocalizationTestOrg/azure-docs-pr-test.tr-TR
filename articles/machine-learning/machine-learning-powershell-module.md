...
Gerçek dünya senaryoda modülü kullanmak nasıl genişletilmiş bir örneği için ayrıntılı kullanım örneği denetleyin [birçok Machine Learning modellerini ve web hizmeti uç noktalarını PowerShell kullanarak bir deneme oluşturma](machine-learning-create-models-and-endpoints-with-powershell.md).
