...
Bu izlenecek yol beşinci adımdır [Azure Machine learning'de Tahmine dayalı analiz çözümü geliştirme](machine-learning-walkthrough-develop-predictive-solution.md)
...
> [!TIP]
> Daha fazla bilgi isterseniz ne olur Tahmine dayalı bir deneme eğitim denemenizi dönüştürürken bkz [modelinizi Azure Machine Learning Studio'da dağıtımına hazırlamak nasıl](machine-learning-convert-training-experiment-to-scoring-experiment.md).
...
> [!NOTE] 
> Yeni bir web hizmeti dağıtmak için web hizmetini dağıtma abonelikte yeterli izniniz olması gerekir. Daha fazla bilgi için bkz: [Azure Machine Learning Web Hizmetleri Portalı'nı kullanarak bir web hizmetini yönetmek](machine-learning-manage-new-webservice.md). 
...
- - -
**Sonraki: [web hizmetine erişim](machine-learning-walkthrough-6-access-web-service.md)**
