...
* -Deneme dönüştürme [modelinizi Azure Machine Learning Studio'daki dağıtımı için hazırlama](machine-learning-convert-training-experiment-to-scoring-experiment.md)
* Web hizmeti - dağıtma [bir Azure Machine Learning web hizmetini dağıtma](machine-learning-publish-a-machine-learning-web-service.md)
* model - yeniden eğitme [yeniden eğitme Machine Learning modellerini programlama aracılığıyla](machine-learning-retrain-models-programmatically.md)
