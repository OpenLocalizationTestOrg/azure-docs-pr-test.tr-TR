...
Makalede ele alınan olarak Pandas veri çerçevesi ile çalışabilir artık [veri bilimi ortamınızdaki işlem Azure Blob veri](machine-learning-data-science-process-data-blob.md).

## <a name="azure-data-science-in-action-example"></a>Azure veri bilimi eylem örnekte
Azure veri bilimi ortak bir veri kümesini kullanarak işlem uçtan uca kılavuz örneği için bkz: [Azure veri bilimi eylem işleminde](machine-learning-data-science-process-sql-walkthrough.md).
