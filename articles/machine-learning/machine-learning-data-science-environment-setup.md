...
* Bazı gelişmiş analizler yaparken karşılaşabileceğiniz senaryo kataloğu için bkz: [takım veri bilimi işlemi için senaryolar](machine-learning-data-science-plan-sample-scenarios.md)
...
**Microsoft Veri bilimi sanal makine (DSVM)** ayrıca bir Azure sanal makine (VM) görüntü olarak kullanılabilir. Bu VM önceden yüklenir ve veri analizi ve makine öğrenme için yaygın olarak kullanılan birkaç popüler araçları ile yapılandırılır. Hem Windows hem de Linux DSVM kullanılabilir. Daha fazla bilgi için bkz: [bulut tabanlı veri bilimi sanal makine için bir giriş Linux ve Windows için](machine-learning-data-science-virtual-machine-overview.md).
