...
Klasik Web hizmeti yeniden eğitme işlemini eksiksiz bir anlatım için bkz [yeniden eğitme Machine Learning modellerini program aracılığıyla](machine-learning-retrain-models-programmatically.md).
...
2. Machine Learning sekmesini açın. 
   ![Makine leaning sekmesini tıklatın.][image4]
...
1. [Klasik Azure portalında](https://manage.windowsazure.com) oturum açın.
2. Machine Learning sekmesini açın. 
   ![Machine learning çalışma alanı UI.][image4]
