...
Rota filtre zaten bir hattına bağlıysa, BGP topluluk listesine güncelleştirmeleri otomatik olarak yayar kurulan BGP oturumları aracılığıyla uygun önek tanıtım değişiklikleri. Aşağıdaki komutu kullanarak, rota filtre BGP topluluk listesini güncelleştirebilirsiniz:
