...
* Bir /29 alt ağı kullanıldığında iki /30 alt ağına bölünür. 
  * ilk hello/30 alt ağı hello birincil bağlantı için kullanılan ve ikinci /30 hello alt hello ikincil bağlantı için kullanılır.
...
Toouse a.b.c.d/29 tooset eşliği hello yukarı seçerseniz iki/30 alt bölünür. Merhaba aşağıdaki örnekte, hello a.b.c.d/29 alt ağının nasıl kullanıldığına bakın. 
...
IP adresi ve AS numarasının emin olduğunuz hello birinde kayıtlı tooyou izleyen kayıt defterleri:
