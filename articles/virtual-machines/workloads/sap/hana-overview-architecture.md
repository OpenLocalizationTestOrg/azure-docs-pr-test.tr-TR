...
- Azure (büyük örneği) altyapısı damga üzerinde bir SAP HANA içinde birçok farklı kiracıların dağıtılır ve diğer karşı ağ, depolama ve işlem düzeyinde Kiracı kavramları aracılığıyla yalıtılmış. 
...
Seçilen belirli yapılandırmalar, iş yükü, CPU kaynaklarını ve istenen bellek bağımlıdır. OLTP iş yükü OLAP iş yükü için en iyi duruma getirilir SKU'ları kullanmak mümkündür. 
...
SKU'ları, LUN üzerinde depolanan önyükleme birimi sınıf türü ile şifrelenir. II sınıf örneklerinin SKU'ları, HANA büyük türü durumunda işletim sistemi yöntemleriyle LUN önyükleme şifrelemeniz gerekir. 
