...
Disk boyutunu artırmayı önce kimliği veya disk adı gerekli. Kullanım [az disk listesi](/cli/azure/vm/disk#list) bir kaynak grubunda tüm diskleri döndürülecek komutu. Yeniden boyutlandırma istediğiniz disk adını not edin.
...
Bir sanal makine disk anlık oluşturmadan önce kimliği veya disk adı gerekli. Kullanım [az vm Göster](https://docs.microsoft.com/en-us/cli/azure/vm#show) disk kimliği döndürülecek komutu. Bu örnekte, böylece daha sonraki bir adımda kullanılabilir disk kimliği bir değişkende depolanır.
...
İlk disk adı kullanarak verileri bulma [az disk listesi](https://docs.microsoft.com/cli/azure/disk#list) komutu. Bu örnek diskin adını adlı bir değişkende yerleştirir *datadisk*, sonraki adımda kullanılır.

```azurecli-interactive 
datadisk=$(az disk list -g myResourceGroupDisk --query "[?contains(name,'myVM')].[name]" -o tsv)
```

Kullanım [az vm diskini](https://docs.microsoft.com/cli/azure/vm/disk#attach) diski eklemek için komutu.
