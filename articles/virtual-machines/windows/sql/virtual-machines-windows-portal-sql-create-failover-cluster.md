...
1. Depolama sanal makineye ekleyin. Ayrıntılı bilgi için bkz: [depolama ekleme](../../../storage/common/storage-premium-storage.md).
...
Küme araştırma bağlantı noktası parametresini ayarlamak için aşağıdaki komut dosyası, ortamınızdan değişkenlerde güncelleştirin.
