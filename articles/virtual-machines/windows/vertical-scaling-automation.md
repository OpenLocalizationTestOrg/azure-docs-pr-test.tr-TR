...
toodo gereken ilk şey hello hello kullanılan runbook'ları tooscale barındıracak bir Azure Otomasyonu hesabı bir sanal makine oluşturmaktır. Yakın zamanda hello Otomasyon hizmeti otomatik olarak hello çalışan runbook'ları hello kullanıcı adına çok kolay için hello hizmet sorumlusu ayarlama kılan hello "Farklı Çalıştır hesabı" özellik sunulmuştur. Daha fazla bilgiyi bu konuda aşağıdaki hello makale:
