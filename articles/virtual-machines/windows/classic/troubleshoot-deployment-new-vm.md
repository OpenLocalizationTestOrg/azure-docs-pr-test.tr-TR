---
title: "aaaTroubleshoot Windows VM dağıtımı-Klasik | Microsoft Docs"
...
Her iki bu hataları tooresolve karşıya özgün VHD, mevcut şirket içi Merhaba, ile aynı hello hello (genelleştirilmiş/özel) işletim sistemi ayarı. Genelleştirilmiş gibi tooupload toorun sysprep ilk unutmayın. Bkz: [oluşturma ve karşıya yükleme Windows Server VHD tooAzure](createupload-vhd.md) daha fazla bilgi için.
