...
---
# <a name="technical-deep-dive-on-platform-supported-migration-from-classic-tooazure-resource-manager"></a>Teknik ya ilişkin ayrıntılar platform desteklenen geçiş Klasik tooAzure Kaynak Yöneticisi'nden
Hello Azure Klasik dağıtım modeli toohello Azure Resource Manager dağıtım modelinden geçirme üzerinde bir derin Dalış atalım. Biz kaynak kaynakları bakın ve nasıl hello Azure platformu hello iki dağıtım modelleri arasında kaynakları geçirir anlamak düzeyi toohelp özellik. Daha fazla bilgi için lütfen hello hizmet duyuru makaleyi okuyun: [Klasik tooAzure Resource Manager Iaas kaynaklardan Platform desteklenen geçişini](migration-classic-resource-manager-overview.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
