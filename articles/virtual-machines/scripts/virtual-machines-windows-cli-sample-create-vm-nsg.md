...
Bu komut dosyası iki sanal makine oluşturur ve gelen trafiği tooboth güvenliğini sağlar. Bir sanal makine üzerinde erişilebilir olduğundan hello Internet ve bir ağ güvenlik grubu (NSG) tooallow trafiği 3389 numaralı bağlantı noktası ve bağlantı noktası 80 üzerinde yapılandırdı. Merhaba ikinci sanal makine üzerinde erişilebilir değil Internet hello ve sahip bir NSG yapılandırılmış tooonly izin hello ilk sanal makineye gelen trafiği. 
