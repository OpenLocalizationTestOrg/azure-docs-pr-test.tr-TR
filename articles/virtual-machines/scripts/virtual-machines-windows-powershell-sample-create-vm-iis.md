...
Bu komut dosyasını Windows Server 2016 çalıştıran bir Azure sanal makine oluşturur ve ardından hello Azure sanal makine özel betik uzantısının tooinstall IIS kullanır. Merhaba komut dosyasını çalıştırdıktan sonra hello varsayılan IIS Web sitesinde hello genel IP adresi hello sanal makinenin erişebilir.
...
| [Set-AzureRmVMExtension](/powershell/module/azurerm.compute/set-azurermvmextension) | VM uzantısı toohello sanal makine ekleyin. Bu örnekte kullanılan tooinstall IIS hello özel komut dosyası uzantısıdır. |
