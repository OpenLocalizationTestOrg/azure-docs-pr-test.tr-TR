...
Burada `[namespace]` ve `SharedAccessKey` alanından elde edilen [Azure portal] [ Azure portal] bir hizmet veri yolu ad alanı oluşturduğunuzda. Daha fazla bilgi için bkz: [Azure portalını kullanarak bir hizmet veri yolu ad alanı oluşturma][Create a Service Bus namespace using the Azure portal].
