...
Bu makalede, bir hizmet veri yolu ad alanı türü oluşturan bir Azure Resource Manager şablonu kullanmayı açıklar **ileti** standart/temel SKU ile. Makale ayrıca dağıtım yürütme için belirtilen parametreleri tanımlar. Bu şablonu kendi dağıtımlarınız için kullanabilir veya kendi gereksinimlerinize göre özelleştirebilirsiniz.
...
Şablon (temel, standart veya Premium) Bu parametre için izin verilen değerleri tanımlar ve herhangi bir değer belirtilmezse varsayılan değer (standart) atar.
