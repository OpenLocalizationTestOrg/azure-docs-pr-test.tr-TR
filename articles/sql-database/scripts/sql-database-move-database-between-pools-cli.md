...
[!code-azurecli-interactive[Ana](../../../cli_scripts/sql-database/move-database-between-pools/move-database-between-pools.sh "veritabanı havuzları arasında taşıma")]
...
| [az sql esnek havuzları oluşturma](https://docs.microsoft.com/cli/azure/sql/elastic-pool#create) | Bir esnek havuz mantıksal sunucu içindeki oluşturur. |
