...
---
# <a name="use-powershell-tooimport-a-bacpac-file-into-an-azure-sql-database"></a>Bir Azure SQL veritabanına PowerShell tooimport bir bacpac dosyası kullanın
...
| [AzureRmSqlServer yeni](/powershell/module/azurerm.sql/new-azurermsqlserver) | Konaklar SQL veritabanı hello mantıksal sunucu oluşturur. |
| [New-AzureRmSqlServerFirewallRule](/powershell/module/azurerm.sql/new-azurermsqlserverfirewallrule) | Merhaba girilen IP adresi aralığından hello sunucusunda bir güvenlik duvarı kuralı tooallow erişim tooall SQL veritabanları oluşturur. |
| [AzureRmSqlDatabaseImport yeni](/powershell/module/azurerm.sql/new-azurermsqldatabaseimport) | İçeri aktarmalar .bacpac bir dosya ve hello sunucuda yeni bir veritabanı oluşturun. |
