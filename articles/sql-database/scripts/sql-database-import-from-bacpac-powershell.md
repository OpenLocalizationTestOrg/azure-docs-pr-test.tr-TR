...
Bu PowerShell Betiği örneği bir veritabanından içe aktaran bir **bacpac** bir Azure SQL veritabanı dosyasına.  

[!INCLUDE [sample-powershell-install](../../../includes/sample-powershell-install-no-ssh.md)]

## <a name="sample-script"></a>Örnek komut dosyası

[!code-powershell[Ana](../../../powershell_scripts/sql-database/import-from-bacpac/import-from-bacpac.ps1?highlight=18-19 "SQL veritabanı oluşturma")]
...
| [AzureRmSqlDatabaseImport yeni](/powershell/module/azurerm.sql/new-azurermsqldatabaseimport) | İçeri aktarmalar .bacpac bir dosya ve sunucuda yeni bir veritabanı oluşturun. |
