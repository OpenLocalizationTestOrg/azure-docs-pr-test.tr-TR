...
---
# <a name="use-powershell-toosync-between-multiple-azure-sql-databases"></a>Birden çok Azure SQL veritabanı arasında PowerShell toosync kullanın
 
Bu PowerShell örnek birden fazla Azure SQL veritabanı arasında veri eşitlemeye toosync yapılandırır.
