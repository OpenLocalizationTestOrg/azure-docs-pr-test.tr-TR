...
[!code-powershell[Ana](../../../powershell_scripts/sql-database/setup-geodr-and-failover-database/setup-geodr-and-failover-database.ps1?highlight=17-20 "tek veritabanı için etkin coğrafi çoğaltma ayarlama")]
