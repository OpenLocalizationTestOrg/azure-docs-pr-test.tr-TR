...
---
# <a name="use-powershell-toocopy-a-sql-database-tooa-new-server"></a>PowerShell toocopy bir SQL veritabanı tooa yeni sunucusuna kullanın

Bu PowerShell komut dosyası örnek yeni bir sunucu varolan bir veritabanının bir kopyasını oluşturur. 

[!INCLUDE [sample-powershell-install](../../../includes/sample-powershell-install-no-ssh.md)]

## <a name="copy-a-database-tooa-new-server"></a>Veritabanı tooa yeni bir sunucu kopyalama
...
| [AzureRmSqlDatabaseCopy yeni](/powershell/module/azurerm.sql/new-azurermsqldatabasecopy) | Merhaba geçerli saati hello anlık görüntü kullanan bir veritabanının bir kopyasını oluşturur. |
