---
title: "aaaAzure uygulama ağ geçidi belgeleri - öğreticileri, API Başvurusu | Microsoft Docs"
description: "Bilgi nasıl toodeploy bir bulut uygulama teslim denetleyicisi. Belgeleri nasıl tooset uygulama düzeyinde yönlendirme ayarlama ve Yük Dengeleme için web ön uç gösterir."
...
Bilgi nasıl toodeploy uygulama ağ geçidi, bir uygulama teslim denetleyicisi (ADC) bir hizmet olarak. Öğreticiler, API başvuru ve diğer belgelerin nasıl tooset uygulama düzeyinde Yönlendirme ve Yük Dengeleme sağlayan Hizmetleri yapı ölçeklenebilir ve yüksek oranda kullanılabilir bir web ön uç gösterir.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Uygulama ağ geçidi hello Azure portal kullanarak ile çalışmaya başlama</h3>
                    </div>
                </div>
            </div>
        </div>
