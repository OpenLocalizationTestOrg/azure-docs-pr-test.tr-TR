...
Tüm makaleler ve nasıl yapılır yönergeleri ASEs hakkında kullanılabilir olan [uygulama hizmeti ortamları için Benioku][ASEReadme]:
...
* Birden çok ASEs yatay olarak ölçeklendirmek için kullanılabilir. Daha fazla bilgi için bkz: [coğrafi olarak dağıtılan uygulama ayak izini ayarlamak nasıl](https://azure.microsoft.com/documentation/articles/app-service-app-service-environment-geo-distributed-scale/).
