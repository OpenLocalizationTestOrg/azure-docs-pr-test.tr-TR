...
* Yerel önbellek okuma-yazma. Ancak, web uygulaması sanal makineleri taşıdığında veya yeniden değişiklikler atılacak. Kritik verileri içerik deposunu uygulamaları için yerel önbelleği kullanmamanız gerekir.
...
* D:\Home yerel önbelleğe işaret. D:\Local geçici VM belirli depolama alanına işaret eden devam eder.
* SCM sitenin varsayılan içerik görünümü, paylaşılan içerik deposu olmaya devam edecektir.
...
İle birlikte yerel önbelleği kullanmanızı öneririz [hazırlama ortamlarını](../app-service-web/web-sites-staged-publishing.md) özelliği.
...
Hazırlama ortamlarını ile yerel önbelleği özelliğini kullanıyorsanız değiştirme işlemi yerel önbelleği warmed tamamlanmayacak. Siteniz yerel önbelleğe karşı çalışıp çalışmadığını denetlemek için çalışan işlem ortam değişkenini denetleyebilir `WEBSITE_LOCALCACHE_READY`. Yönergeleri kullanın [çalışan işlem ortam değişkeni](https://github.com/projectkudu/kudu/wiki/Process-Threads-list-and-minidump-gcdump-diagsession#process-environment-variable) birden çok örneği üzerinde çalışan işlem ortam değişkeni erişmek için sayfa.  
...
Depolama içeriği kopyalar adımının bir parçası depo adlı herhangi bir klasör edilmeyecek. Bu web uygulamasının günlük işleminde gerekli olmayan bir kaynak denetimi deponuza sitenizin içeriğinin nerede içerebilir senaryolarında yardımcı olur. 
