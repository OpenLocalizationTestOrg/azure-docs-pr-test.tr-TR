...
* [İOS uygulamanıza kimlik doğrulaması ekleme] [ iOS] (veya [Android], [Windows], [Xamarin.iOS], [ Xamarin.Android], [Xamarin.Forms], veya [Cordova])
...
* Uygulamanızı ulaşmak yalnızca kimliği doğrulanmış istekler izin verir.
    ...
    Bir tarayıcı adsız bir istek alırsa, uygulama hizmeti seçtiğiniz ve böylece kullanıcılar oturum açabilir kimlik sağlayıcısı için bir sayfaya yönlendirilirsiniz. İstek bir mobil CİHAZDAN geliyorsa, döndürülen yanıtın bir HTTP'dir *401 Yetkisiz* yanıt.
...
Aşağıdaki öğreticiler bir web uygulaması için kimlik doğrulaması ekleme gösterir:
...
Aşağıdaki öğreticiler API uygulamalarınızı nasıl koruyacağınızı:
