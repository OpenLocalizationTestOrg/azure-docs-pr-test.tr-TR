...
İlk olarak, verdiğiniz *sample.log* ve *hivesampletable* Azure SQL veritabanına veya SQL Server ve mobil cihaz verileri içeren tablo aşağıdaki yolu kullanarak Hdınsight'a geri alın:
...
2. Aşağıdaki özellikleri girin:
    ...
    - **Bacpac dosya adı**: kendi backpac dosyanızı kullanmak istemediğiniz sürece varsayılan değeri kullanın.
     ...
     Lütfen bu değerleri yazın.  Öğreticinin sonraki bölümlerinde bunlara ihtiyacınız olacaktır.
...
5. Kaynak veri dosyası önceden işleyebilir.
    ...
    Bu verileri kullanan diğer örnekler için ince budur ancak biz Azure SQL veritabanı ya da SQL Server içeri aktarmadan önce bu özel durumlar kaldırmanız gerekir. Sqoop verme başarısız boş bir dize veya daha az sayıda olan bir satır varsa Azure SQL veritabanı tablosunda tanımlanan alanların sayısından. Log4jlogs Tablo 7 dize türü alan yok.
