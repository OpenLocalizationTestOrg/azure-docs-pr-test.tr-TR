...
* **Add-AzureRmAccount**: Azure PowerShell'i Azure aboneliğinize doğrular
...
1. Bir düzenleyici kullanarak aşağıdaki kodu olarak Kaydet **hivejob.ps1**.
    ...
    [!code-powershell[Ana](../../powershell_scripts/hdinsight/use-hive/use-hive.ps1?range=5-42)]
...
3. İş tamamlandığında, bilgileri aşağıdaki thext benzer döndürür:
...
4. Daha önce belirtildiği gibi **Invoke-Hive** bir sorgu çalıştırın ve yanıt için beklemek için kullanılabilir. Invoke-Hive nasıl çalıştığını görmek için aşağıdaki komut dosyasını kullanın:
    ...
    [!code-powershell[Ana](../../powershell_scripts/hdinsight/use-hive/use-hive.ps1?range=50-71)]
...
İş tamamlandığında hiçbir bilgi döndürülürse, işleme sırasında bir hata oluşmuş olabilir. Bu işi için hata bilgilerini görüntülemek için aşağıdaki sonuna ekleyin **hivejob.ps1** dosya, dosyayı kaydedin ve yeniden çalıştırın.
...
Bu cmdlet iş çalıştırdığınızda STDERR sunucuda yazılır bilgileri döndürür.
