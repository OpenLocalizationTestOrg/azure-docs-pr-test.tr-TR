...
3. Jupyter not defteri tıklatın **karşıya** içinde sağ üst köşe ve GitHub deposunu kopyaladığınız konuma gidin.
    ...
    ![Azure Hdınsight Spark kümesinde Jupyter not defteri karşıya](./media/hdinsight-apache-spark-microsoft-cognitive-toolkit/hdinsight-microsoft-cognitive-toolkit-load-jupyter-notebook.png "Azure Hdınsight Spark kümesi için karşıya yükleme Jupyter not defteri")
