...
* **Hdınsight kümesi**. Bir yapılandırma için bkz: [Azure Hdınsight kullanmaya başlama][hdinsight-get-started].
...
* [Excel'i Microsoft Hive ODBC sürücüsü ile Hdınsight bağlama][hdinsight-ODBC]
* [Hdınsight'a verileri yükleme][hdinsight-upload-data]
