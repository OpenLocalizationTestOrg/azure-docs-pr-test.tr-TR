...
| [Bir web uygulamasını redis önbelleği için bağlama](./../app-service-web/scripts/app-service-cli-app-service-redis.md) | Azure web uygulaması ve redis önbelleği oluşturur, ardından redis bağlantı ayrıntıları için uygulama ayarları ekler. |
|**Önbellek Sil**||
