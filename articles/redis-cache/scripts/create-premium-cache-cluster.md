...
Bu senaryoda, nasıl toocreate bir 6 GB Premium Katmanı'Kümeleme ile Azure Redis önbelleği etkin ve iki parça öğrenin.
...
Bu komut dosyasını etkinleştir Kümeleme ile bir kaynak grubu ve Premium katmanı redis önbelleği komutları toocreate aşağıdaki hello kullanır. Her komut hello tablosundaki toocommand belirli belgeleri bağlar.
