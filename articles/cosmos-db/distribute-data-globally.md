...
Veritabanınızın işlem yapmanızı belirli bir bölgede çevrimdışı hesap ve hale getirmek azure Cosmos DB etkinleştirir daha sonra yeniden çevrimiçi. Çevrimdışı olarak işaretlenmiş bölgeleri etkin olarak çoğaltmasında katılmak ve yük devretme dizisinin bir parçası değildir. Bu, riskli olabilecek uygulamanızı çalışırken önce okuma bölgelerinden son bilinen iyi veritabanı Görüntüyü Dondur olanak sağlar.
