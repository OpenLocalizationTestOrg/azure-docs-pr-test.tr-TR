...
---
# <a name="azure-cosmos-db-create-an-mongodb-api-account-using-hello-azure-cli"></a>Azure Cosmos DB: hello Azure CLI kullanarak bir API MongoDB hesabı oluşturma
