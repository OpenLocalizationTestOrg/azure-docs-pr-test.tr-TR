...
---
# <a name="create-a-failover-policy-for-high-availability-using-hello-azure-cli"></a>Hello Azure CLI kullanarak yüksek kullanılabilirlik için yük devretme ilkesi oluşturma
