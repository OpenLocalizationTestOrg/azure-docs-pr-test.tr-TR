...
---
# <a name="get-account-keys-for-azure-cosmos-db-using-hello-azure-cli"></a>Hello Azure CLI kullanarak Azure Cosmos DB için hesap anahtarı alma
...
| [az cosmosdb listesi anahtarlar](https://docs.microsoft.com/cli/azure/cosmosdb#list-keys) | Konaklar SQL veritabanı hello mantıksal sunucu oluşturur. |
