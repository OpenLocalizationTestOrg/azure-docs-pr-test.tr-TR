...
**Standart katmanı** algılama özellikleri dahil olmak üzere, tehdit Intelligence, davranış analizi, anomali algılama, güvenlik olaylarına ve tehdit attribution raporları Gelişmiş tehdit ekler. Standart katmanı ilk 60 gün boyunca ücretsizdir. 60 gün ötesinde hizmeti kullanmaya devam etmek seçmesi gereken, biz otomatik olarak hizmet için kaydedilecek başlatın.  Yükseltmek için fiyatlandırma katmanı seçin [Güvenlik İlkesi](security-center-policies.md#set-security-policies). Daha fazla bilgi için bkz: [Güvenlik Merkezi fiyatlandırma](security-center-pricing.md).
