...
toocreate uçtan uca veri ambarı çözüm, geniş çeşitli endüstri lideri Araçlar'ı seçin. Bu makalede, Azure SQL Data Warehouse destekleyen veri tümleştirme çözümleri Microsoft iş ortağı şirketlerden vurgular.

## <a name="our-data-integration-partners"></a>Veri tümleştirme ortaklarımızın
| Partner | Açıklama | Bağlantılar | Videolar |
| --- | --- | --- | --- |
| ![Alteryx][1] |**Alteryx**<br> Alteryx Tasarımcısı tekrarlanabilir bir iş akışı toodeeper Öngörüler değil geleneksel yaklaşım tipik hello hafta saat içindeki müşteri adayları Self Servis veri analizi için sağlar! Veri hazırlama, harmanlama, verileri bir araya getirerek veri çözümleyiciler Alteryx Tasarımcısı güçlendirir ve hello aynı sezgisel bir kullanıcı arabirimi – Tahmine dayalı, istatistiksel ve uzamsal – analizi kullanarak. |[Market][alteryx_marketplace]<br>[Web sitesi][alteryx_designer_website]<br>[Teknik incelemesi][alteryx_whitepaper]<br>[Veri sayfası][alteryx_designer_datasheet]<br>[Twitter][alteryx_designer_twitter]<br>[YouTube][alteryx_designer_youtube] |[![Alteryx video](./media/sql-data-warehouse-partner-data-integration/alteryx_designer_video.jpg)](https://www.youtube.com/watch?v=CdqSDPyNDKc) |
| ![Attunity][2] |**Attunity**<br>Attunity CloudBeam veri tooSQL veri ambarını yüklemek için otomatik ve en iyi duruma getirilmiş bir çözüm sağlar. "Tıklatın yük" tasarım ile basitleştirir ve hem toplu yükleme, hem de SQL Server, Oracle, DB2, Sybase ve mySQL dahil olmak üzere birçok heterojen veritabanlarındaki artımlı çoğaltma hızlandırır. |[Market][attunity_marketplace]<br>[Hızlı Başlangıç][attunity_quickstart]<br>[Web sitesi][attunity_cloudbeam_website]<br>[Veri sayfası][attunity_cloudbeam_datasheet]<br>[Twitter][attunity_cloudbeam_twitter]<br>[YouTube][attunity_cloudbeam_youtube] |[![Attunity video](./media/sql-data-warehouse-partner-data-integration/attunity_video.jpg)](https://www.youtube.com/watch?v=w14zuSjMlok) |
| ![Bryte sistemleri][3] |**Bryte sistemleri**<br>Veri aktarımı tooSQL veri ambarı çeşitli veritabanlarından ve kaynakları Bryte sistemleri otomatikleştirir. Bryte sistemleri veri hareketlerini ve tümleştirme teknolojileri uzmanlaşmış. Bunlar, ölçeklenebilir bulut tabanlı veri ambarlarında ve veri Göller toouncover Öngörüler oluşturun. |[Market][bryte_systems_marketplace]<br>[Web sitesi][bryte_systems_azure_website] | |
| ![Informatica][4] |**Azure Kullandıkça Öde Informatica bulut Hizmetleri**<br> Azure hizmetlerinizi Hello değeri iyileştirmek ve eyleme dönüştürülebilir Öngörüler, Azure – Kullandıkça Öde için Informatica bulut hizmetleriyle tüm karma veri kümeleri dışında türetilir. Informatica bulut veri tümleştirme, bulut analiz, uygulama tümleştirme ve veri yönetimi için en iyi sınıf bir çözüm sunar. Self Servis veri geçişi ile tümleştirme ve yönetim yetenekleri müşteriler hızlı ve güvenilir bir şekilde içeri aktarma, dışarı aktarabilir, eşitleme ve zamanlama kaynakları SaaS uygulamaları, Hadoop tabanlı veri Göller gibi çeşitli veri tooAzure petabaytlarca ve diğer şirket içi veri kaynakları (Oracle, SAP).  Azure için Informatica bulut hizmetleri sağlayan yerel, yüksek birim, yüksek performanslı bağlantı tooAzure SQL Data Warehouse, Sgl veritabanı, Blob Storage, Data Lake Store ve DocumentDB. |[Market][informatica_Cloud_Services_marketplace]<br>[Ücretsiz deneme sürümü][informatica_cloud_free_trial]<br>[Yapılandırma Kılavuzu][informatica_cloud_services_config]<br>[Web sitesi][informatica_Cloud_Services_website]<br>[Veri sayfası][informatica_cloud_datasheet]<br>[Twitter][informatica_cloud_twitter]<br>[YouTube][informatica_cloud_youtube] | |
| ![Informatica][4] |**Informatica PowerCenter**<br>Informatica hello dünyanın en tanınabilir bağımsız sağlayıcıları veri tümleştirme yazılımın biridir. Tüm veri tümleştirme girişimlerini temeli PowerCenter forms hello. PowerCenter analytics, veri ambarı, uygulama geçiş, birleştirme veya veri yönetimi için kullanın. |[Market (standart)][informatica_PowerCenter_std_marketplace]<br>[Market (Gelişmiş)][informatica_PowerCenter_adv_marketplace]<br>[Web sitesi][informatica_PowerCenter_website]<br>[Veri sayfası][informatica_powercenter_datasheet]<br>[Twitter][informatica_powercenter_twitter]<br>[YouTube][informatica_powercenter_youtube] | |
| ![Redgate][5] |**Redgate veri platformu Studio (Önizleme)**<br>Redgate'nın veri platformu Studio basit ve güvenilir bir yol toomigrate SQL veritabanları tooAzure SQL Data Warehouse şirket içi sağlar. Toomake akıllı kararları tam otomatik geçiş için tasarlanmış ve bir kerelik geçişler için ücretsiz toouse değil. |[Web sitesi][redgate_website]<br>[Twitter][redgate_twitter]<br>[YouTube][redgate_youtube] |[![Redgate video](./media/sql-data-warehouse-partner-data-integration/redgate_video.jpg)](https://www.youtube.com/watch?v=IR9HNvnU46s) |
| ![SnapLogic][6] |**SnapLogic**<br>Merhaba SnapLogic tümleştirme Platformu (iPaaS) hizmet olarak müşteriler tooquickly aktarım verilerini içine ve dışına Microsoft Azure SQL Data Warehouse sağlar.  SnapLogic hello özelliği toointegrate uygulamaları, hizmetleri ve bir çözümde IOT senaryolarını yüzlerce sunar. Hızlı ve etkili Öngörüler hello bulutta şirket içi veya karma modda SnapLogic teslim! |[Market][snaplogic_marketplace]<br>[Web sitesi][snaplogic_website]<br>[Veri sayfası][snaplogic_datasheet]<br>[Twitter][snaplogic_twitter]<br>[YouTube][snaplogic_youtube] |[![Snaplogic video](./media/sql-data-warehouse-partner-data-integration/snaplogic_video.jpg)](https://www.youtube.com/watch?v=YiJCwObOh5Y) |

## <a name="next-steps"></a>Sonraki Adımlar
diğer ortaklarımızın, bazıları hakkında daha fazla toolearn bkz [iş zekası ortakları] [ bi_partners] ve [veri yönetimi ortakları][dm_partners].
