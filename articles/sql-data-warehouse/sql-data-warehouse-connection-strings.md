...
Gibi birçok farklı uygulama kurallarıyla tooSQL veri ambarına bağlanabilir [ADO.NET][ADO.NET], [ODBC][ODBC], [PHP] [ PHP] ve [JDBC][JDBC]. Bağlantı dizeleri her protokol için bazı örnekleri aşağıda verilmiştir.  Bağlantı dizenizi hello Azure portal toobuild de kullanabilirsiniz.  toobuild hello Azure portal, bağlantı dizesi kullanarak tooyour veritabanı dikey altında gidin *Essentials* tıklayın *veritabanı bağlantı dizelerini Göster*.
...
> [!NOTE]
> Ayar hello bağlantı zaman aşımı too300 saniye cinsinden sipariş tooallow hello bağlantı toosurvive kısa süreyle kullanılamazlık göz önünde bulundurun.
> 
> 
