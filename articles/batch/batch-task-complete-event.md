---
title: "aaa \"Azure Batch görev complete olayını | Microsoft Docs\""
...
# <a name="task-complete-event"></a>Görev tamamlandı olayı
 ...
 Bu olay, bir görev tamamlandığında hello çıkış kodu bağımsız olarak yayılır. Bu olay, kullanılan toodetermine hello bir görevin süresini hello görev çalıştığı olmalı ve onu yeniden olup olmadığını görüntüleyebilirsiniz.


 Merhaba aşağıdaki örnek görev complete olayını hello gövdesi gösterir.
