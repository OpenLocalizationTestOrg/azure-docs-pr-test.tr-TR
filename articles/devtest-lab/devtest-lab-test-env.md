...
5. **Denetim maliyetleri**
   ...
   | [Tüm Laboratuvar bir PowerShell komut dosyası kullanarak sanal makineleri silin](devtest-lab-faq.md#how-can-i-automate-the-process-of-deleting-all-the-vms-in-my-lab) |Test tamamlandığında tek bir işlemde tüm labs silin.|
