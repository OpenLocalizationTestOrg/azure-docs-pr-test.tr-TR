...
#### Merhaba IOT ağ geçidi Starter Kit kullanın
##### [Intel NUC cihazını ağ geçidi olarak ayarlama](iot-hub-gateway-kit-c-lesson1-set-up-nuc.md)
##### [Merhaba ağ geçidi tooIoT Hub Bağlan](iot-hub-gateway-kit-c-iot-gateway-connect-device-to-cloud.md)
##### [Veri dönüştürme için hello ağ geçidini kullan](iot-hub-gateway-kit-c-use-iot-gateway-for-data-conversion.md)
...
### [IOT hub'ı iletileri tooAzure veri depolama Kaydet](iot-hub-store-data-in-azure-table-storage.md)
...
# Nasıl yapılır?
## Planlama
### [IOT hub'ı tooEvent Hubs karşılaştırması](iot-hub-compare-event-hubs.md)
...
##### [Cihaz bulut iletilerini tooIoT Hub Gönder](iot-hub-devguide-messages-d2c.md)
##### [Merhaba yerleşik uç noktasından cihaz bulut iletilerini okuyun](iot-hub-devguide-messages-read-builtin.md)
...
#### [Denetim erişim tooIoT Hub](iot-hub-devguide-security.md)
...
### [Merhaba IOT cihaz SDK'sı için C kullanın](iot-hub-device-sdk-c-intro.md)
#### [Merhaba IoTHubClient kullanın](iot-hub-device-sdk-c-iothubclient.md)
#### [Merhaba seri hale getirici kullanın](iot-hub-device-sdk-c-serializer.md)
...
### Cihaz işleri tooupdate cihaz üretici yazılımını kullanın
...
## Yönet
### IoT hub oluşturma 
#### [Merhaba portalını kullanın](iot-hub-create-through-portal.md)
...
#### [Merhaba REST API kullanın](iot-hub-rm-rest.md)
...
#### [Merhaba portalını kullanın](iot-hub-configure-file-upload.md)
...
## Güvenlik
### [Plan hello güvenlikten](iot-hub-security-ground-up.md)
