...
* İçin **parola** alan, bir SAS belirteci kullanın. SAS belirteci biçimi hem HTTP hem de AMQP protokolleri aynıdır:<br/>`SharedAccessSignature sig={signature-string}&se={expiry}&sr={URL-encoded-resourceURI}`.
...
> [!NOTE]
> Bu `{property_bag}` öğesini kullanan sorgu dizeleri HTTP protokolü için olduğu gibi aynı kodlama.
>
>
