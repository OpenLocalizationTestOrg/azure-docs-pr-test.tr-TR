...
Kullanım **ExportDevicesAsync** yöntemi bir IOT hub kimlik kayıt defterine tamamen dışarı aktarmak için bir [Azure Storage](../storage/index.md) blob kapsayıcısı kullanarak bir [paylaşılan erişim imzası](../storage/common/storage-security-guide.md#data-plane-security).
