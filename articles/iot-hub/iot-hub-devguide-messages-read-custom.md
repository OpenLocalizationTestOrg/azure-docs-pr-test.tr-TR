...
IOT hub'ı varsayılan olan [yerleşik uç nokta][lnk-built-in]. Hub'ına diğer hizmetler aboneliğinizde bağlayarak iletileri yönlendirmek için özel uç noktaları oluşturabilirsiniz. IOT hub'ı şu anda özel uç noktalar olarak Event Hubs, Service Bus kuyrukları ve Service Bus konu başlıklarını destekler.
