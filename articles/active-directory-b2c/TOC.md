...
## [Hello Azure AD grafik API'sini kullanın](active-directory-b2c-devquickstarts-graph-dotnet.md)
...
## [Merhaba UI Özelleştirme](active-directory-b2c-reference-ui-customization.md)
...
## [Raporlama API'si hello kullanın](active-directory-b2c-reference-usage-reporting-api.md)
