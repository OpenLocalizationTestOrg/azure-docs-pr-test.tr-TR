...
Bir uygulama hizmeti ortamı yapılandırmak için de başvurabilirsiniz [Belgelerimizi](app-service-web-how-to-create-an-app-service-environment.md) konu hakkında. Oluşturulan bir uygulama hizmeti ortamı olduktan sonra oluşturabileceğiniz [Web Apps](app-service-web-overview.md), [API uygulamaları](../app-service-api/app-service-api-apps-why-best-platform.md) ve [Mobile Apps](../app-service-mobile/app-service-mobile-value-prop.md) Bu ortamdaki tüm biz yapılandırmak bir sonraki bölümde WAF arkasında korunur.
