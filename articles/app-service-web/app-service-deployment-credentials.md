...
1. İçinde [Azure portal](https://portal.azure.com), uygulama hizmeti tıklayın >  **&lt;any_app >** > **dağıtım kimlik bilgileri**.
    ...
    > [!NOTE]
    > Portalda dağıtım kimlik bilgileri dikey penceresini erişebilmeniz için önce en az bir uygulama olmalıdır. Bununla birlikte, [Azure CLI](app-service-web-app-azure-resource-manager-xplat-cli.md), kullanıcı düzeyinde kimlik bilgileri olan bir uygulama olmadan yapılandırabilirsiniz.
