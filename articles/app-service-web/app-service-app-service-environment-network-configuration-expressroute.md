...
Bir uygulama hizmeti ortamı oluşturulabilir **ya da** bir Azure Resource Manager sanal ağ **veya** Klasik dağıtım modeli sanal ağı.  Haziran 2016'da yapılan son bir değişiklikle ASEs ayrıca artık, ortak adres aralıkları veya RFC1918 adres alanlarını (örn.) kullanan sanal ağlar dağıtılabilir özel adresler). 
