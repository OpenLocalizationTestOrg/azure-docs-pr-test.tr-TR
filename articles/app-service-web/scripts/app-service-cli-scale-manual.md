...
[!code-azurecli-interactive[Ana](../../../cli_scripts/app-service/scale-manual/scale-manual.sh "el ile ölçek")]
...
| [az uygulama hizmeti planı güncelleştirme](https://docs.microsoft.com/cli/azure/appservice/plan#update) | Uygulama hizmeti planının özelliklerini güncelleştirir. |
