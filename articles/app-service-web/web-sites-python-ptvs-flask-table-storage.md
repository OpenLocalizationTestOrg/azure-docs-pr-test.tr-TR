...
---
# <a name="flask-and-azure-table-storage-on-azure-with-python-tools-22-for-visual-studio"></a>Flask ve Visual Studio için Python araçları 2.2 ile azure'da Azure tablo depolaması
Bu öğreticide, kullanacağız [Visual Studio için Python Araçları] toocreate basit bir web uygulamasına hello PTVS örnek şablonlarından birini kullanarak yoklar. Bu öğretici olarak da kullanılabilir bir [video](https://www.youtube.com/watch?v=qUtZWtPwbTk).
...
2. Proje şablonlarını hello hello [Visual Studio Örnekleri VSIX için Python araçları 2.2] altında kullanılabilir **Python**, **örnekleri**. Seçin **yoklamalar Flask Web projesi** ve Tamam toocreate hello proje'yi tıklatın.
...
2. Merhaba tıklatın **yeni** hello üst simgesine sol hello Portal ', ardından **veri + depolama** > **depolama hesabı**. Tıklayın **oluşturma**, ardından hello depolama hesabı benzersiz bir ad verin ve yeni bir [kaynak grubu](../azure-resource-manager/resource-group-overview.md) onun için.
...
3. Merhaba tıklatın **erişim tuşları** hello depolama hesabı dikey penceresinde parçası. Merhaba hesap adı ve hello key1 not edin.
...
Bu bölümde, yeni oluşturduğumuz bizim uygulama toouse hello depolama hesabı yapılandıracağız. Azure Portal tooobtain bağlantı ayarlarını nasıl hello göreceğiz. Ardından hello uygulama yerel olarak çalıştıracaksınız.
...
1. İçinde [Azure Portal](https://portal.azure.com), tıklayarak hello web uygulamanızın dikey penceresini açmak **Gözat** > **uygulama hizmetleri** >, web uygulaması adı.
...
Visual Studio, Flask ve Azure tablo depolaması için Python araçları hakkında daha fazla bu bağlantılar toolearn izleyin.
