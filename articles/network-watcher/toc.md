...
## IP akışları tooand bir VM'den doğrulayın
...
## [Paket yakalama toofind anormallikleri Çözümle](network-watcher-deep-packet-inspection.md)
## [Paket yakalama toodo öngörülü ağ ile Azure işlevleri izleme kullanın](network-watcher-alert-triggered-packet-capture.md)
