...
2. Klasik Portalı'nı açın ya da sanal makineye bağlanmak için kullanılan bir '.rdp' uzantısına sahip bir dosyayı kaydetmek isteyip istemediğinizi sorar. Yükleme tamamlandığında dosyayı açmak için tıklatın.
