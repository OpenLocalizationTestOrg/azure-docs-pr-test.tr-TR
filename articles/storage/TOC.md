...
### [Yönetilen disk tooa Windows VM ekleme PowerShell'i kullanma](../virtual-machines/windows/attach-disk-ps.md)
...
### [Anonim erişim tooblobs](storage-manage-access-to-resources.md)
...
### [Azure VM'ler tooAzure yönetilen diskleri geçirme](../virtual-machines/windows/migrate-to-managed-disks.md)
### [AWS ve diğer platformlar tooManaged diskleri geçirme](../virtual-machines/windows/on-prem-to-azure.md)
...
#### [Geçirme tooPremium Azure Site Recovery kullanarak depolama](storage-migrate-to-premium-storage-using-azure-site-recovery.md)
...
#### [TooPremium depolama birimi geçirme](storage-migration-to-premium-storage.md)
...
### [Merhaba depolama öykünücüsü kullanın](storage-use-emulator.md)
...
## Veri Aktarma
### [Depolama biriminden veri tooand Taşı](storage-moving-data.md)
### [Windows üzerinde AzCopy](storage-use-azcopy.md)
### [Linux üzerinde AzCopy](storage-use-azcopy-linux.md)
### [Merhaba içeri/dışarı aktarma hizmeti kullanma](storage-import-export-service.md)
### [Merhaba Import/Export aracını kullanma](storage-import-export-tool-how-to.md)
#### [Merhaba içeri/dışarı aktarma aracı ayarlama](storage-import-export-tool-setup.md)
...
#### [Sorun giderme hello içeri/dışarı aktarma aracı](storage-import-export-tool-troubleshooting-v1.md)
...
### [Merhaba içeri/dışarı aktarma Aracı (v1) kullanma](storage-import-export-tool-how-to-v1.md)
#### [Merhaba içeri/dışarı aktarma aracı ayarlama](storage-import-export-tool-setup-v1.md)
...
#### [İçeri/Dışarı Aktarma hizmeti meta veriler ve özellikler dosyası biçimi](storage-import-export-file-format-metadata-and-properties.md)
#### [İçeri/Dışarı Aktarma hizmeti günlük dosyası biçimi](storage-import-export-file-format-log.md)
### [Hello Azure içeri/dışarı aktarma hizmeti REST API kullanma](storage-import-export-using-the-rest-api.md)
