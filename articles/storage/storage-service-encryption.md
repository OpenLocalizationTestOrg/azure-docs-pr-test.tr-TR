...
Azure File storage standart SMB protokolü kullanılarak bulutta dosya paylaşımları sağlar. Şirket içinde veya Azure bir istemciden bir dosya paylaşımı bağlayabilir. Takılı sonra Azure dosya paylaşımları üzerinden dosyaları kopyalamak için Robocopy gibi araçlar kullanılabilir. Daha fazla bilgi için bkz: [Windows Azure dosya paylaşımı nasıl](storage-file-how-to-use-files-windows.md) ve [Linux'ta Azure dosya paylaşımının nasıl](storage-how-to-use-files-linux.md).
...
Daha fazla bilgi için lütfen ziyaret bizim [.NET kullanarak Azure Blob storage'ı kullanmaya başlama](storage-dotnet-how-to-use-blobs.md).
