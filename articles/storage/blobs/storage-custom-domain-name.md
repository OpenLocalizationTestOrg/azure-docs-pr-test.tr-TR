...
Kullanım [az depolama hesabı güncelleştirme](https://docs.microsoft.com/cli/azure/storage/account#update) CLI komut ve boş bir dize belirtin (`""`) için `--custom-domain` özel etki alanı kaydını kaldırmak için bağımsız değişken değeri.
