...
Klasik Azure portalında bir Klasik depolama hesabı bu değerleri almak için:

1. Oturum [Klasik Azure portalı](https://manage.windowsazure.com).
2. Kullanmak istediğiniz depolama hesabınıza gidin.
3. Tıklatın **erişim ANAHTARLARINI Yönet** alt gezinti bölmesi.
4. Açılan iletişim, depolama hesabı adı ve birincil erişim anahtarını ikincil erişim anahtarını görürsünüz. Erişim anahtarı için birincil veya ikincil bir kullanabilirsiniz. 
5. Anahtarı panoya kopyalamak için Kopyala simgesine tıklayın.
