...
AzCopy toocopy bir dosya tooanother veya toocopy blob tooa dosya ya da tam tersini de kullanabilirsiniz. Bkz: [hello AzCopy komut satırı yardımcı programı ile veri aktarma](storage-use-azcopy.md).
...
Ayrıca, çok başvuruda bulunabilir[Azure File storage sorun giderme makalesi](storage-troubleshoot-file-connection-problems.md) uçtan uca sorun giderme kılavuzu için.
