...
* Merhaba .NET istemci kitaplığı toocreate paylaşılan erişim imzaları ve depolanan erişim ilkeleri kullanma öğreticileri bunlar.
  ...
  * [Paylaşılan erişim imzası, bölüm 2: Oluşturma ve bir SAS hello Blob hizmeti ile kullanma](storage-dotnet-shared-access-signature-part-2.md)
...
#### <a name="resources"></a>Kaynaklar
* [Şifrelemek ve şifresini çözmek Azure anahtar kasası kullanılarak Microsoft Azure Storage blobları](storage-encrypt-decrypt-blobs-key-vault.md)
