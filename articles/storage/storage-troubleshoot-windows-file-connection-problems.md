...
İstemcide NTLMv1 iletişim etkinse, sistem hatası 53 veya sistem hatası 87 ortaya çıkabilir. Azure File storage yalnızca NTLMv2 kimlik doğrulamasını destekler. Etkin NTLMv1 sahip daha az güvenli bir istemci oluşturur. Bu nedenle, iletişim için Azure File storage engellendi. 
...
Bazı tanıtıcıları kapatarak eşzamanlı açık tanıtıcı sayısını azaltın ve yeniden deneyin. Daha fazla bilgi için bkz: [Microsoft Azure Storage performans ve ölçeklenebilirlik Yapılacaklar listesi](storage-performance-checklist.md).

<a id="slowfilecopying"></a>
## <a name="slow-file-copying-to-and-from-azure-file-storage-in-windows"></a>Ve Windows Azure dosya depolama biriminden dosya kopyalama yavaş
...
-   Sağ copy yöntemini kullanın:
    -   Kullanım [AzCopy](storage-use-azcopy.md#file-copy) iki dosya paylaşımları arasında herhangi bir aktarım için.
...
### <a name="cause"></a>Nedeni
Şifreleme Dosya Sistemi (EFS) kullanıyorsanız, bu sorun oluşabilir. BitLocker ile şifrelenmiş dosyaları Azure dosya depolama alanına kopyalanabilir. Ancak, Azure File storage NTFS EFS desteklemez.
