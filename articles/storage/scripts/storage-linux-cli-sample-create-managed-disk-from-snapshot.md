...
[!code-azurecli[Ana](../../../cli_scripts/storage/create-managed-disks-from-snapshot/create-managed-disks-from-snapshot.sh "yönetilen diskten anlık görüntü oluşturma")]
