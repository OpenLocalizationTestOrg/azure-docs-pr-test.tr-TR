...
Aşağıdaki örnek içeriğini yükler **sunset.png** içine dosya **myblob** blob.
...
Aşağıdaki örnek, kullanma gösterir **almak\_blob\_için\_yolu** içeriğini indirmek için **myblob** blob ve onun için depolamak **çıkış sunset.png** dosya.
