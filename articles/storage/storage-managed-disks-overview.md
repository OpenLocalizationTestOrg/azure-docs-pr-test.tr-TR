...
Azure yönetilen diskleri hello yöneterek Azure Iaas VM'ler için disk yönetimi basitleştirir [depolama hesapları](storage-introduction.md) hello VM disklerle ilişkilendirilmiş. Yalnızca toospecify hello türüne sahip ([Premium](storage-premium-storage.md) veya [standart](storage-standard-storage.md)) ve hello boyutu duyduğunuz disk ve Azure oluşturur ve hello disk tarafından yönetilir.
...
**Depolama türü:** yönetilen diskleri 2 performans katmanı sunar: [Premium](storage-premium-storage.md) (SSD tabanlı) ve [standart](storage-standard-storage.md) (HDD tabanlı). yönetilen bir diskin Hello faturalama depolama türünü hello disk için seçtiğiniz üzerinde bağlıdır.
...
[Artımlı anlık görüntüleri](storage-incremental-snapshots.md) şu anda yönetilen disklerde desteklenmez, ancak hello gelecekte desteklenecektir.
...
* [Nasıl toocapture yönetilen bir Azure genelleştirilmiş bir VM görüntüsü](../virtual-machines/windows/capture-image-resource.md)
* [Azure CLI 2.0 toogeneralize ve kullanarak bir Linux sanal makine yakalama nasıl hello](../virtual-machines/linux/capture-image.md)
...
* [Yönetilen veri diski tooa Windows VM ekleme PowerShell'i kullanma](../virtual-machines/windows/attach-disk-ps.md)

* [Yönetilen disk tooa Linux VM ekleme](../virtual-machines/linux/add-disk.md)
...
* [AWS ve diğer platformlar Azure tooManaged diskleri geçirme](../virtual-machines/windows/on-prem-to-azure.md)

* [Azure VM'ler toomanaged diskleri Azure Dönüştür](../virtual-machines/windows/migrate-to-managed-disks.md)
