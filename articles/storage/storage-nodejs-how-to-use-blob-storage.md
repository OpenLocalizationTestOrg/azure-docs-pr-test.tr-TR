...
Yönergeler için toocreate bir Node.js uygulaması bkz [Azure App Service'te bir Node.js web uygulaması oluşturma], [derleme ve bir Node.js uygulaması tooan Azure bulut hizmeti dağıtma] --Windows PowerShell'i kullanma , veya [ve Web Matrix kullanarak bir Node.js web uygulaması tooAzure dağıtacak].
...
Hello hello ortam değişkenlerini ayarlama örneği için [Azure portal](https://portal.azure.com) Azure web uygulaması için bkz: [Node.js web app kullanarak hello Azure tablo hizmeti].
...
* [Azure Depolama düğümü API Başvurusu için SDK'sı][Azure Storage SDK for Node API Reference]
