...
Blob storage uç nokta tooa eşlenen nerede istediğiniz toospecify açık bir uç nokta bir senaryo olduğunda [özel etki alanı](../blobs/storage-custom-domain-name.md). Bu durumda, bağlantı dizenizi Blob storage için özel uç noktanızı belirtebilirsiniz. Uygulamanız bunları kullanıyorsa diğer hizmetler hello için hello varsayılan uç noktalar isteğe bağlı olarak belirtebilirsiniz.
