...
İstemci tarafı şifreleme ve Azure anahtar kasası kullanarak blob'lara şifreleme hello işleminde size yol gösterir bir adım adım öğretici için bkz: [Azure anahtar kasası kullanılarak Microsoft Azure Storage blobları şifreleme ve şifre çözme](../blobs/storage-encrypt-decrypt-blobs-key-vault.md).
