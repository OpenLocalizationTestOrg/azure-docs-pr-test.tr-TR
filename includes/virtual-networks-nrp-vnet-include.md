...
| --- | --- | --- |
| **addressSpace** |CIDR gösteriminde hello VNet oluşturan adres öneklerini koleksiyonu |192.168.0.0/16 |
| **alt ağlar** |VNet hello yapmak alt koleksiyonu |bkz: [alt ağlar](#Subnets) aşağıda. |
...
| Özellik | Açıklama | Örnek değerler |
| --- | --- | --- |
| **addressPrefix** |Merhaba alt ağ CIDR gösteriminde oluşturan tek adresi öneki |192.168.1.0/24 |
| **networkSecurityGroup** |NSG uygulanır toohello alt ağ |bkz: [Nsg'ler](#Network-Security-Group) |
| **routeTable** |Yol tablosu toohello alt uygulanan |bkz: [UDR](#Route-table) |
| **Ipconfigurations** |NIC bağlı toohello alt ağı tarafından kullanılan IP yapılandırma nesneleri koleksiyonu |bkz: [UDR](#Route-table) |
...
* Okuma hello [REST API başvuru belgeleri](https://msdn.microsoft.com/library/azure/mt163650.aspx) sanal ağlar için.
* Okuma hello [REST API başvuru belgeleri](https://msdn.microsoft.com/library/azure/mt163618.aspx) alt ağlar için.
