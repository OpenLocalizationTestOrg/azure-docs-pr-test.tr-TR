...
* Azure Storage ile çalışmak üzere yazdığınız kodları nasıl sadeleştireceğinizi öğrenin kullanıma [Azure WebJobs SDK nedir](../articles/app-service-web/websites-dotnet-webjobs-sdk.md)
