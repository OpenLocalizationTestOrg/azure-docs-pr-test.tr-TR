...
3. Merhaba arama kutusuna hello Microsoft Update Kataloğu hello Bilgi Bankası (KB) numarasını girin hello düzeltme toodownload, örneğin istediğiniz **3179904**ve ardından **arama**.
   
    Merhaba düzeltme listesi, örneğin, göründüğünde **StorSimple 8000 serisi için toplu yazılım paketini güncelleştirme 2.2**.
...
5. Ek düzeltmeleri arayın hello yukarıdaki tabloda listelenen (**3103616**, **3146621**) ve her toohello Sepeti ekleyin.
...
4. Tür **Y** zaman istendiğinde tooconfirm hello düzeltme yükleme.
   ...
   > [!IMPORTANT]
   > Güncelleştirme 2.2 yüklüyorsanız, yalnızca 'tüm-hcsmdssoftwareudpate' ile başlayan hello ikili dosya yükleyin. İle tüm cismdsagentupdatebundle başında hello CIS ve hello MDS aracı güncelleştirmesi yüklemeyin. Hata toodo şekilde bir hatayla sonuçlanır. 
...
1. Merhaba yazılım güncelleştirmesi tamamlandıktan sonra hello sistem yazılım sürümleri doğrulayın. Şunu yazın:
   ...
   * `MdsAgentVersion: 30.0.4698.16` 
     ...
     > 
     > 
2. 3-5 tooinstall hello normal modu düzeltmeleri kalan adımları yineleyin.
   
   * Merhaba iSCSI güncelleştirme KB3146621
   * Merhaba WMI güncelleştirme KB3103616
3. Güncelleştirme 2'den güncelleştiriyorsanız bu adımı atlayın. Bir sürüm önceki tooUpdate 2 güncelleştiriyorsanız toodownload de gerekir:

    - Merhaba LSI sürücü KB3121900

    - Merhaba Spaceport güncelleştirme KB3090322

    - Merhaba Storport güncelleştirme KB3080728
