* [Coğrafi Olarak Dağıtılan Uygulama Ayak İzi Ayarlama](../articles/app-service-web/app-service-app-service-environment-geo-distributed-scale.md)
* [Katmanlı Güvenlik Mimarisi Uygulama](../articles/app-service-web/app-service-app-service-environment-layered-security.md) 
* [App Service Ortamında Web Uygulaması Güvenlik Duvarı Yapılandırma](../articles/app-service-web/app-service-app-service-environment-web-application-firewall.md)
