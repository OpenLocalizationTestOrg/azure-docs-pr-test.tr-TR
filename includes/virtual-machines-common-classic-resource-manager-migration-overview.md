...
| Ağ |Sanal ağ ExpressRoute ağ geçidi ve VPN ağ geçidi ile  | Geçiş işlemine başlamadan önce VPN ağ geçidi kaldırın ve geçiş tamamlandıktan sonra VPN ağ geçidini yeniden oluşturun. Daha fazla bilgi edinmek [ExpressRoute geçiş](../articles/expressroute/expressroute-migration-classic-resource-manager.md).|
| Ağ |ExpressRoute ile yetkilendirme bağlantılar  | Geçişe başlamadan önce virtaul ağ bağlantısı için expressroute bağlantı hattı kaldırın ve geçiş tamamlandıktan sonra bağlantı yeniden oluşturun. Daha fazla bilgi edinmek [ExpressRoute geçiş](../articles/expressroute/expressroute-migration-classic-resource-manager.md). |
...
| İşlem |Geçiş bağlantısı VPN ağ geçidi veya ExpressRoute ağ geçidi şirket içi DNS sunucusuyla sahip bir VNET ile Azure Güvenlik Merkezi uzantıları |Azure Güvenlik Merkezi, kendi güvenlik izleme ve uyarılar yükseltmek için sanal makinelerde uzantıları otomatik olarak yükler. Azure Güvenlik Merkezi ilke abonelikte etkinse, bu uzantılar genellikle otomatik olarak yüklenir. ExpressRoute ağ geçidi geçişi şu anda desteklenmiyor ve VPN ağ geçitleri geçiş bağlantısı ile şirket içi erişim kaybeder. ExpressRoute silme ağ geçidi veya geçiş bağlantı geçirme VPN ağ geçidi Internet erişimi VM depolama hesabına geçişi gerçekleştirmeden ile etmeden zaman kaybolmasına neden olur. Konuk Aracısı durumu blobu doldurulamaz gibi böyle bir durumda geçiş devam etmez. Geçiş işlemine devam etmeden önce 3 saat aboneliğe ilişkin Azure Güvenlik Merkezi ilke devre dışı bırakmak için önerilir. |
