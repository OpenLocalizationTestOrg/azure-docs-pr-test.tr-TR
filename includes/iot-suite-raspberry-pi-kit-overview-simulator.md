...
- Bilgisayarınız ve hello Uzaktan izleme çözümü ile cihaz toocommunicate ayarlayın.
- Merhaba örnek aygıt kodu tooconnect toohello Uzaktan izleme çözümü güncelleştirmek ve hello çözüm panosunda görüntüleyebilirsiniz sanal telemetriyi gönderin.
...
Bir masaüstü bilgisayar tooenable, tooconnect uzaktan toohello komut satırı Raspberry Pi'yi hello üzerinde.

[Microsoft IOT Starter Kit Raspberry Pi 3] [ lnk-starter-kits] veya eşdeğer bileşenleri. Bu öğretici aşağıdaki hello Seti'nden öğelerindeki hello kullanır:
