...
| --- | --- | --- |
| **DNSzones** |Etki alanı bölgesi bilgi toohost DNS kayıtlarını belirli bir etki alanı |/ subscriptions/{guid}/.../providers/Microsoft.Network/dnszones/contoso.com " |
...
Okuma hello [DNS bölgeleri için REST API belgeleri ](https://msdn.microsoft.com/library/azure/mt130626.aspx) daha fazla bilgi için.

Okuma hello [DNS kayıt kümelerini için REST API belgeleri](https://msdn.microsoft.com/library/azure/mt130627.aspx) daha fazla bilgi için.
