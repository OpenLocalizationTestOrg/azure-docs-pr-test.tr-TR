...
izleyen hello bölümler genellikle bölgelerinde bulunan standart bileşenleri ele alınacaktır.
...
"Hizmet" Bu bağlamda herhangi bir yazılım bileşeni veya cihazlara sahip bir alan veya Bulut ağ geçidi üzerinden veri toplama ve analiz için yanı sıra komut ve denetim için arabirim modülü olarak tanımlanmıştır.  Ortam araçları hizmetleridir. Bunlar kimliklerini ağ geçitleri ve diğer alt sistemleri doğrultusunda altında hareket, depolamak ve verileri çözümlemek, sınırlarına sorunu komutları toodevices verilerin veya zamanlamaları göre bilgi ve denetim özellikleri tooauthorized son kullanıcılar kullanıma.
...
Microsoft Azure IOT modelleme toodo tehdit yukarıda özetlenen hello çerçevesi kullanır. Merhaba aşağıdaki bölümde bu nedenle Azure IOT başvuru mimarisi toodemonstrate nasıl IOT ve nasıl tooaddress tehditleri hello tehdit modelleme hakkında toothink tanımlanmış somut örneği hello kullanırız. Örneğimizde dört ana odak alanı belirledik:
